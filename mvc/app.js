...
/// vcl em dùng const đi var lầ quá khứ rồi 2 nam truoc roi :))
...
let header = fs.readFileSync(
  path.join(__dirname, "views", "user", "template", "header.hbs"),
  "utf-8"
);
let footer = fs.readFileSync(
  path.join(__dirname, "views", "user", "template", "footer.hbs"),
  "utf-8"
);
let headeradmin = fs.readFileSync(
  path.join(__dirname, "views", "admin", "template", "header.hbs"),
  "utf-8"
);
let footeradmin = fs.readFileSync(
  path.join(__dirname, "views", "admin", "template", "footer.hbs"),
  "utf-8"
);
let headerwriter = fs.readFileSync(
  path.join(__dirname, "views", "writer", "template", "header.hbs"),
  "utf-8"
);
let footerwriter = fs.readFileSync(
  path.join(__dirname, "views", "writer", "template", "footer.hbs"),
  "utf-8"
);
let headereditor = fs.readFileSync(
  path.join(__dirname, "views", "editor", "template", "header.hbs"),
  "utf-8"
);
let footerediter = fs.readFileSync(
  path.join(__dirname, "views", "editor", "template", "footer.hbs"),
  "utf-8"
);

{
  ...
  hbs.registerHelper("Sub", function (str) {
    //bỏ múi giờ
